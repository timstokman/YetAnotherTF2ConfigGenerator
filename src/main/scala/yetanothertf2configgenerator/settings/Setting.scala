...
object Setting {
   ...
   * * Scala has no listed group by (would be nice to have)
   */
  ...
  lazy val settings = List[Setting[_, _ <: Component]](
    ...
    ClassDependencySetting(tf2Class => WeaponDependencySetting(weapon => DoubleSetting("sensitivity", "Mouse sensitivity", tf2Class, weapon, 1.0, 'options, Some(0.0), None), true), true),
    ...
    ClassDependencySetting(tf2Class => WeaponDependencySetting(weapon => BooleanSetting("show", "Show weapon", tf2Class, weapon, true, 'options), false), true),
    ...
    ClassDependencySetting(tf2Class => WeaponDependencySetting(weapon => IntSetting("scales", "Crosshair scale", tf2Class, weapon, 24, 'options, Some(0), None), false), true),
    ClassDependencySetting(tf2Class => WeaponDependencySetting(weapon => DoubleSetting("dingVolume", "Dingaling volume", tf2Class, weapon, 1.0, 'options, Some(0.0), None), false), true),
    ClassDependencySetting(tf2Class => WeaponDependencySetting(weapon => IntSetting("dingPitchMax", "Dingaling pitch max", tf2Class, weapon, 50, 'options, Some(0), None), false), true),
    ClassDependencySetting(tf2Class => WeaponDependencySetting(weapon => IntSetting("dingPitchMin", "Dingaling pitch max", tf2Class, weapon, 100, 'options, Some(0), None), false), true),
    ClassDependencySetting(tf2Class => BooleanSetting("enableCrouchJump", "Enable crouch-jump", tf2Class, 0, false, 'options), true),
    ClassDependencySetting(tf2Class => DoubleSetting("interpRatio", "Interp-ratio: ", tf2Class, 0, 1.0, 'options, Some(0.0), None), false),

    IntAsBooleanSetting("dingEnable", "Enable weapon dingalings", "any", 0, 1, 'options),
    IntAsBooleanSetting("damagenumbers", "Enable damage numbers", "any", 0, 1, 'options),
    BooleanSetting("hideTracers", "Hide hitscan tracers", "any", 0, true, 'options),
    BooleanSetting("enableSprays", "Enable sprays", "any", 0, true, 'options),
    BooleanSetting("enableGibs", "Enable gibs", "any", 0, true, 'options),
    BooleanSetting("enableRagdolls", "Enable ragdolls", "any", 0, true, 'options),
    IntAsBooleanSetting("autoreload", "Enable autoreload", "any", 0, 1, 'options),
    IntSetting("fov", "Field of view", "any", 0, 90, 'options, Some(70), Some(90)),
    IntAsBooleanSetting("fastswitch", "Enable weapon fastswitch", "any", 0, 1, 'options),
    IntSetting("viewmodelFov", "Viewmodel field of view", "any", 0, 80, 'options, Some(0), None),
    ...
    DoubleSetting("zoomFactor", "Zoom factor", "any", 0, 1.2, 'options, Some(0.0), Some(1.2)),
    IntSetting("scoreboardNetgraph", "Netgraph type when scoreboard pops up", "any", 0, 0, 'options, Some(0), Some(4)),
    BooleanSetting("precEnabled", "I use P-Rec", "any", 0, false, 'options),
    IntSetting("precLog", "P-Rec log mode", "any", 0, 0, 'options, Some(0), Some(4)),
    IntAsBooleanSetting("precScreens", "P-Rec take screenshots of scoreboard/status", "any", 0, 0, 'options),
    IntAsBooleanSetting("precDeleteUseless", "P-Rec delete useless demos w/o bookmarks/killstreaks", "any", 0, 0, 'options),
    IntSetting("precMinStreak", "P-Rec minimum killstreak", "any", 0, 4, 'options, Some(0), None),
    IntSetting("precKillDelay", "P-Rec killstreak delay", "any", 0, 15, 'options, Some(0), None),
    StringSetting("precDir", "P-Rec demo directory", "any", 0, "", 'options),
    IntSetting("precMode", "P-Rec mode", "any", 0, 0, 'options, Some(0), None),
    IntSetting("autocallThreshold", "Autocall threshold", "medic", 0, 75, 'options, Some(0), None),
    BooleanSetting("showHealBeam", "Show heal beam", "medic", 0, true, 'options),
    StringSetting("medicSayFake", "Chat on uber faked", "medic", 0, "", 'options),
    StringSetting("medicSayUber", "Chat on uber popped", "medic", 0, "", 'options),
    DoubleSetting("zoomSensitivity", "Zoom sensitivity", "sniper", 0, 1.0, 'options, Some(0.0), None),
    IntAsBooleanSetting("noCrossHairZoom", "No crosshair zoom", "sniper", 0, 0, 'options),
    IntAsBooleanSetting("fullChargeBell", "Full charge bell", "sniper", 0, 1, 'options),
    BooleanSetting("showFlames", "Show flames", "pyro", 0, true, 'options),
    BooleanSetting("showViewmodelCloak", "Show viewmodel on cloak/DR", "spy", 0, true, 'options),
    ...
    IntAsBooleanSetting("enableSpecTournamentMode", "Enable spectator tournament mode", "any", 0, 1, 'options),
    ClassDependencySetting(tf2Class => TextareaSetting("extraScripts", "Additional scripts", tf2Class, 0, "", 'options), false),
    TextareaSetting("autoexecExtraScript", "Additional scripts", "any", 0, "", 'options),
