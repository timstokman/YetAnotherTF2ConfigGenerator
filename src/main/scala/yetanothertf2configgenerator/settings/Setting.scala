...
object Setting {
  ...
  lazy val settings = List[Setting[_, _ <: Component]](
    ...
    IntAsBooleanSetting("dingEnable", "Enable weapon dingalings (hit sounds)", "any", 0, Some(1), 'options),
    ...
    IntSetting("autocallThreshold", "Auto medic-call threshold", "medic", 0, Some(75), 'options, Some(0), None),
    ...
    IntAsBooleanSetting("hudMin", "HUD Minimal mode", "any", 0, Some(1), 'options),
    ...
    BindSetting("meleeSwap", "Swap current/melee weapon", "any"),
    ...
    BindSetting("taunt", "Taunt Weapon", "any"),
    BindSetting("tauntMenu", "Taunt Menu", "any"),
    ...
    BindSetting("reloadhud", "Reload hud/fix graphical glitches", "any"),
    ...
    BindSetting("backpack", "Show character backpack", "any"),
    BindSetting("backpackComplete", "Show entire backpack", "any"),
    ...
    BindSetting("disguiseMenuToggle", "Toggle friendly/enemy disguises within menu", "spy"),
